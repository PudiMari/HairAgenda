        ...
        <div className="px-6 py-8">
          ...
          {clientAppointments.filter((app: any) => app.status?.toUpperCase() !== 'CANCELLED').length > 0 ? (
            ...
            <div className="bg-white p-8 rounded-2xl border-2 border-dashed border-slate-200 text-center">
              ...
              <p className="text-xs text-amber-600 font-medium mt-4 bg-amber-50 rounded-lg p-3 inline-block">
                Para agendar seu 1º horário, acesse o <strong>link de convite</strong> enviado pelo seu profissional parceiro.
              </p>
            </div>
          )}
        </div>
